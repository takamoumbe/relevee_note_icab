            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <form class="forms-sample" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>Modifier_Etudiant">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="nom étudiant..." minlength="3" maxlength="30" name="nom" autocomplete="off"  value="<?php echo $etudiant->nom; ?>"/>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="nom étudiant..." minlength="3" maxlength="30" name="prenom" autocomplete="off" value="<?php echo $etudiant->prenom; ?>"/>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" placeholder="matricule étudiant..." name="date_naiss" autocomplete="off"  value="<?php echo $etudiant->date_naiss ?>"/>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Lieu naissance étudiant..." minlength="3" maxlength="30" name="lieu_naiss" autocomplete="off"  value="<?php echo $etudiant->lieu_naiss; ?>"/>
                            </div>
                            ...
                            <div class="form-group col-md-6 autocomplete">
                                ...
                                <input id="myInput" type="text" class="form-control" placeholder="Filière étudiant..." name="filiere" autocomplete="off"  value="<?php echo $etudiant->filiere; ?>"/>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Ex: 657807309" name="contact" maxlength="9" minlength="9" autocomplete="off"  value="<?php echo $etudiant->contact; ?>"/>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Tuteur étudiant..." minlength="3" maxlength="30"  name="tuteur" autocomplete="off"   value="<?php echo $etudiant->tuteur; ?>"/>
                            </div>
